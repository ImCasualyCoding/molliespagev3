...
const websiteContent = {
    ...
    journey: {
        ...
        paragraphs: [
            ...
            "Whether you’re rebuilding strength, improving mobility, or striving for your next level of fitness, I'll be here to guide you with expertise, patience, and unwavering support. Together, we’ll create a stronger, healthier, more confident you."
        ]
    },
...
function renderFooter() {
    ...
    businessCard.innerHTML = `
        ...
        <div class="card-contact-info">
            <a href="tel:9542952115" class="card-contact-item">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                </svg>
                <span>(954) 295-2115</span>
            </a>
            <a href="mailto:MollieDiane7@gmail.com" class="card-contact-item">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                    <polyline points="22,6 12,13 2,6"></polyline>
                </svg>
                <span>MollieDiane7@gmail.com</span>
            </a>
        ...
        <div class="card-socials">
            <a href="https://www.instagram.com/move_rx_7?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="social-icon" aria-label="Instagram">
